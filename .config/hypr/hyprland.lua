...
hl.window_rule({ name = "float-alacritty", match = { class = "Alacritty" }, float = true, size = {900, 600} })
hl.window_rule({ name = "float-btop", match = { class = "Btop" }, float = true, size = {1000, 800} })
hl.window_rule({ name = "float-pavucontrol", match = { class = "org.pulseaudio.pavucontrol" }, float = true, size = {800, 600} })
...
hl.window_rule({ name = "float-blueman-manager", match = { class = "blueman-manager" }, float = true, size = {700, 500} })
hl.window_rule({ name = "float-localsend", match = { class = "localsend" }, float = true, size = {700, 500} })
hl.window_rule({ name = "float-nmtui", match = { class = "NMtui" }, float = true, size = {600, 500} })
